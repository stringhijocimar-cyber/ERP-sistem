    ...
    <div class="ss-card">
      <div class="ss-card-head">
        ...
        <div style="display:flex;gap:8px;align-items:center">
          <input type="text" class="form-control" placeholder="Buscar..." style="max-width:200px;font-size:12px;padding:5px 10px" oninput="ssFiltrarIncidentes(this.value)">
          <select class="form-control" style="max-width:160px;font-size:12px;padding:5px 8px" onchange="ssFiltrarIncidentesStatus(this.value)">
...
function ssFiltrarIncidentes(busca) {
  ...
  const filtrado = txt ? todos.filter(i =>
...
function _ssRenderDocumentosHtml() {
  ...
  <div class="ss-card" style="margin-bottom:14px">
    <div class="ss-card-head">
      <div class="ss-card-title"><i class="fas fa-users" style="color:#ef4444"></i>Colaboradores com Documentação Pendente</div>
...
function _ssRenderTreinamentosHtml() {
  ...
  <div class="ss-card">
    <div class="ss-card-head">
      ...
      <input type="text" class="form-control" placeholder="Buscar colaborador..." style="max-width:200px;font-size:12px;padding:5px 10px" oninput="ssFiltrarColabsTrein(this.value)">
    </div>
    <div class="ss-table-wrap">
...
function ssFiltrarColabsTrein(busca) {
  const colabs = _ssGetColabs();
  const txt = busca.toLowerCase();
  const filtrado = txt ? colabs.filter(c =>
