  ...
  main.innerHTML = `
    <div style="padding:20px 24px;max-width:1400px">
      ...
      <div id="med-painel-cliente">
        ...
        <!-- Filtros -->
        <div class="ss-card" style="padding:12px 16px;margin-bottom:14px">
          <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center">
            <input class="form-control" id="med-busca-c" placeholder="🔍 Buscar..." 
              style="max-width:280px;font-size:13px" oninput="medFiltrarCliente()">
            <select class="form-control" id="med-status-c" style="max-width:170px;font-size:13px" onchange="medFiltrarCliente()">
              <option value="">Todos os Status</option>
              ${['Rascunho','Pendente','Em Aprovação','Aprovada','Faturada','Paga','Reprovada','Contestada'].map(s=>`<option>${s}</option>`).join('')}
            </select>
            <select class="form-control" id="med-tipo-c" style="max-width:170px;font-size:13px" onchange="medFiltrarCliente()">
      ...
      <div id="med-painel-forn" style="display:none">
        ...
        <div class="ss-card" style="padding:12px 16px;margin-bottom:14px">
          <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center">
            <input class="form-control" id="med-busca-f" placeholder="🔍 Buscar..." 
              style="max-width:280px;font-size:13px" oninput="medFiltrarForn()">
            <select class="form-control" id="med-status-f" style="max-width:170px;font-size:13px" onchange="medFiltrarForn()">
              <option value="">Todos os Status</option>
