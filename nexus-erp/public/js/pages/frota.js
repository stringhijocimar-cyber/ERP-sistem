    ...
    <div class="card">
      <div class="search-bar">
        <div class="search-input-wrapper" style="flex:1">
          ...
          <input type="text" class="search-input" id="frotaSearch" placeholder="Buscar por código, descrição, placa, projeto, status…" oninput="filtrarFrota(this.value)">
        </div>
        <select class="filter-select" id="frotaFilterStatus" onchange="filtrarFrota(document.getElementById('frotaSearch').value)">
          <option value="">Todos os Status</option>
          <option>Operacional</option><option>Em Manutenção</option><option>Inativo</option>
        </select>
        <select class="filter-select" id="frotaFilterTipo" onchange="filtrarFrota(document.getElementById('frotaSearch').value)">
          <option value="">Todos os Tipos</option>
          <option>Veículo</option><option>Equipamento</option>
        </select>
      </div>
